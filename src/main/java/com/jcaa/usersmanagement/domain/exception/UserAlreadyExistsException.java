...
public final class UserAlreadyExistsException extends DomainException {
  ...
  private static final String EMAIL_EXISTS_MESSAGE = "A user with email '%s' already exists.";
  ...
  public static UserAlreadyExistsException becauseEmailAlreadyExists(final String email) {
    return new UserAlreadyExistsException(String.format(EMAIL_EXISTS_MESSAGE, email));
  }
}
